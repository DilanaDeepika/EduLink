...
<div class="form-card">
  ...
  <form id="intended-learners-form">
    ...
    <div class="form-group">
      ...
      <textarea class="form-textarea">This course is designed for high school and college students who are new to Physics or want to strengthen their conceptual understanding.</textarea>
    </div>
    ...
    <div class="form-group">
      ...
      <textarea class="form-textarea">No prior Physics knowledge required. Basic understanding of Mathematics (algebra and geometry) will be helpful.</textarea>
    </div>

    <!-- Actions -->
    <div class="form-actions">
      <button type="button" class="btn-save-draft">Save Changes</button>
      <button type="button" id="btn_next-intended" class="btn-next">
