...
<html lang="en">
  <head>
    ...
    <link  href="<?php  echo ROOT ?>/assets/css/profile.css" rel="stylesheet"/>
    <link
      rel="stylesheet"
      ...
      <main class="main-content">
        ...
        <section id="edit-profile" class="content-section">
          ...
          <div class="edit-profile-layout">
            ...
            <div class="avatar-section">
              ...
              <form class="upload-form" action="<?= ROOT ?>/InstituteProfile/uploadPhoto"  method="POST" enctype="multipart/form-data"  data-upload-form>
                <input type="file" class="upload-input" name="logo_path" accept="image/*" hidden data-upload-input />
                <button type="button" class="btn btn-secondary" data-upload-btn>
            ...
            <div class="form-container">
              <form action="<?= ROOT ?>/InstituteProfile/updateProfile" class="profile-form" method="POST">
                <h3>Institute Details</h3>
                <div class="form-group">
                  <label for="inst_name">Institute Name</label>
                  <input type="text" id="inst_name" name="institute_name" value="<?= $institute->institute_name ?>" />
                </div>
                <div class="form-group">
                ...
                <div class="form-row">
                  <div class="form-group">
                    ...
                    <input type="text" id="inst_phone" name="contact_phone" value="<?= $institute->contact_phone ?>" />
                  </div>
                  <div class="form-group">
                    ...
                    <input
                      ...
                      id="inst_time"
                      name="open_time"
                      value="<?= date('h:i A', strtotime($institute->open_time)) ?>"
                    />
                  </div>
                </div>
        ...
        <section id="classes" class="content-section">
          ...
          <div class="classes-list">
            <!-- Class Cards -->
            <?php if(!empty($instituteClasses)): ?>
              <?php foreach($instituteClasses as $class): ?>
                <div class="class-card">
                  <div class="class-info">
                    <h3>
                      <?= htmlspecialchars($class->class_name) ?>
                      <?= $gradeMap[$class->grade_level_name] ?>
                    </h3>
                    <p class="teacher-name">
                      Teacher : <?= trim(($class->teacher_first_name ?? '') . ' ' . ($class->teacher_last_name ?? '')) ?>
                    </p>
                    <div class="class-meta">
                      <span><i class="fa-solid fa-location-dot"></i><?= $class->institute_location ?></span>
                      ...
                      <span>
                        ...
                        Rs <?= number_format($class->revenue, 2) ?><!--check-->
                      </span>
                    </div>
                  </div>
...
<div class="content-header">
         ...
         <div class="profit-stats-grid">
            <div class="profit-stat-card">
              ...
              <div class="stat-details">
                ...
                <h2 class="stat-value">LKR 54,800</h2>
            ...
            <div class="profit-stat-card">
              ...
              <div class="stat-details">
                ...
                <h2 class="stat-value">LKR 8,450</h2>
            ...
            <div class="profit-stat-card">
              ...
              <div class="stat-details">
                <p class="stat-label">Ongoing Classes</p>
                ...
                <div class="class-earning-item">
                  <div class="class-earning-info">
                    ...
                    <div>
                      ...
                      <span class="class-earning-meta">Gr. 12 • 25 students • Completed</span>
                    </div>
                  </div>
                ...
                <div class="class-earning-item">
                  <div class="class-earning-info">
                    ...
                    <div>
                      ...
                      <span class="class-earning-meta">Gr. 11 • 18 students • Ongoing</span>
                    </div>
                  </div>
                  <div class="class-earning-amount">
                    <strong>$2,160</strong>
                ...
                <div class="class-earning-item">
                  <div class="class-earning-info">
                    ...
                    <div>
                      ...
                      <span class="class-earning-meta">Gr. 10 • 15 students • Ongoing</span>
                    </div>
                  </div>
                  <div class="class-earning-amount">
                    <strong>$1,440</strong>
                ...
                <div class="class-earning-item">
                  <div class="class-earning-info">
                    ...
                    <div>
                      ...
                      <span class="class-earning-meta">Gr. 9 • 12 students • Completed</span>
                    </div>
                  </div>
                  <div class="class-earning-amount">
                    <strong>$1,800</strong>
        ...
        <section id="community" class="content-section">
          <div class="content-header">
            ...
            <div id="communityModal" class="community-modal">
              <div class="modal-content">
                ...
                <form action="<?= ROOT ?>/InstituteProfile/createCommunity" method="POST" enctype="multipart/form-data">
          ...
          <form method="GET" action="<?= ROOT ?>/InstituteProfile">
